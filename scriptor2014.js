...
var layout   = require("./layoutdb/DADOS_ENEM_2014");

var file     = "DADOS_ENEM_2014.TXT";
...
function renderinsert(line){
  ...
  return knex("DADOS_ENEM_2014").insert(data).toString();
}
...
rl.on("line",function(line){
  fs.appendFile("DADOS_ENEM_2014.sql",renderinsert(line)+";\r\n");
  lc++;
  if(lc % 10000 == 0)

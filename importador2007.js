...
var file     = "DADOS_ENEM_2007.TXT";// process.argv[2];
...
function lineinsert(line){
  var n = 0;
  return knex("DADOS_ENEM_2007").insert({
  ...
  IN_CONCLUIU            : line.substring(n,n+=1),
  IN_SUPLETIVO           : line.substring(n,n+=8),
  PK_COD_ENTIDADE        : line.substring(n,n+=8),
  CODMUNIC_ESC           : line.substring(n,n+=8),
  ...
  VT_RESP_OBJETIVA       : line.substring(n,n+=100),
  TP_PROVA               : line.substring(n,n+=1),
  VT_GABARITO_PROVA      : line.substring(n,n+=100),
}).then(function(ret){
    return ret;
  });
}

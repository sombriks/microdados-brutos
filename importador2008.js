...
function lineinsert(line){
  var n = 0;
  return knex("DADOS_ENEM_2008").insert({
  NU_INSCRICAO              : line.substring(n,n+=16),
  NU_ANO                    : line.substring(n,n+=8),
  DT_NASCIMENTO             : line.substring(n,n+=20),
  TP_SEXO                   : line.substring(n,n+=1),
  COD_MUNIC_INSC            : line.substring(n,n+=13),
  NO_MUNICIPIO_INSC         : line.substring(n,n+=150),
  CO_UF_INSC                : line.substring(n,n+=8),
  ST_CONCLUSAO              : line.substring(n,n+=8),
  IN_TP_ENSINO              : line.substring(n,n+=1),
  PK_COD_ENTIDADE           : line.substring(n,n+=9),
  COD_MUNICIPIO_ESC         : line.substring(n,n+=15),
  ...
  SIT_FUNC                  : line.substring(n,n+=15),
  ID_CIDADE_PROVA           : line.substring(n,n+=19),
  NO_MUNICIPIO_PROVA        : line.substring(n,n+=50),
  UF_CIDADE_PROVA           : line.substring(n,n+=2),
  IN_PRESENCA               : line.substring(n,n+=8),
  NU_PERCENT_COMP1          : line.substring(n,n+=9),
  NU_PERCENT_COMP2          : line.substring(n,n+=9),
  NU_PERCENT_COMP3          : line.substring(n,n+=9),
  NU_PERCENT_COMP4          : line.substring(n,n+=9),
  NU_PERCENT_COMP5          : line.substring(n,n+=9),
  NU_NOTA_OBJETIVA          : line.substring(n,n+=9),
  ...
  TX_RESPOSTAS              : line.substring(n,n+=200),
  ID_PROVA                  : line.substring(n,n+=8),
  DS_TP_PROVA               : line.substring(n,n+=50),
  DS_GABARITO               : line.substring(n,n+=100),

...
var file     = "DADOS_ENEM_2012.TXT";// process.argv[2];
...
function lineinsert(line){
  var n = 0;
  return knex("DADOS_ENEM_2012").insert({
  ...
  ANO_CONCLUIU              : line.substring(n,n+=4),
  TP_ESCOLA                 : line.substring(n,n+=1),
  IN_TP_ENSINO              : line.substring(n,n+=1),
  TP_ESTADO_CIVIL           : line.substring(n,n+=1),
  TP_COR_RACA               : line.substring(n,n+=1),
  IN_UNIDADE_HOSPITALAR     : line.substring(n,n+=1),
  ...
  IN_SURDO_CEGUEIRA         : line.substring(n,n+=1),
  ...
  IN_IDOSO                  : line.substring(n,n+=1),
  IN_AUTISMO                : line.substring(n,n+=1),
  ...
  IN_MESA_CADEIRA_RODAS     : line.substring(n,n+=1),
  IN_MESA_CADEIRA_SEPARADA  : line.substring(n,n+=1),
  IN_APOIO_PERNA            : line.substring(n,n+=1),
  IN_GUIA_INTERPRETE        : line.substring(n,n+=1),
  IN_CERTIFICADO            : line.substring(n,n+=1),
  NO_ENTIDADE_CERTIFICACAO  : line.substring(n,n+=150),
  UF_ENTIDADE_CERTIFICACAO  : line.substring(n,n+=2),
  ...
  DS_GABARITO_LC            : line.substring(n,n+=50),
...
//QUESTIONARIO_SOCIO_ECONOMICO_ENEM_2012
  NU_INSCRICAO              : line.substring(n,n+=12),
  IN_QSE                    : line.substring(n,n+=1),
  Q1                        : line.substring(n,n+=2),
  Q2                        : line.substring(n,n+=1),
  Q3                        : line.substring(n,n+=1),
  Q4                        : line.substring(n,n+=2),

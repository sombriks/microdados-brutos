...
exports.up = function(knex, Promise) {
  ...
  table.string("NO_MUNICIPIO_INSC" ,150);
  table.string("UF_INSC" ,2);
  table.string("IN_CONCLUIU" ,1);
  table.string("IN_SUPLETIVO" ,8);
  table.string("PK_COD_ENTIDADE" ,8);
  table.string("CODMUNIC_ESC" ,8);
  table.string("NO_MUNICIPIO_ESC" ,150);
  table.string("UF_ESC" ,2);
  table.string("ID_DEPENDENCIA_ADM" ,1);
  table.string("ID_LOCALIZACAO" ,1);
  table.string("SIT_FUNC" ,15);
  ...
  table.string("Q222",1);
  table.string("Q223",1);
  table.string("VT_RESP_OBJETIVA",100);
  table.string("TP_PROVA",1);
  table.string("VT_GABARITO_PROVA",100);
